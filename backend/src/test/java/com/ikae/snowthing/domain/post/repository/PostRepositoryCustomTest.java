...
class PostRepositoryCustomTest {
    ...
    @BeforeEach
    void setUp() {
        freeCategory = categoryRepository.save(
    ...
    void findPostsByOffset_firstPage() {
        // given
        PostSearchRequest request = new PostSearchRequest("FREE", null, null, null, SortType.LATEST, 1, null, 10);
    ...
    void findPostsByCursor_firstPage() {
        // given
        PostSearchRequest request = new PostSearchRequest("FREE", null, null, null, SortType.LATEST, null, null, 10);
    ...
    void findPostsBySearch_titleKeyword() {
        // given
        PostSearchRequest request = new PostSearchRequest("FREE", null, SearchType.TITLE, "설질", SortType.LATEST, 1, null, 10);
