...
/** 무상태 복합 커서 토큰 (Opaque Cursor Token) Base64 유틸리티. 추후 Elasticsearch search_after 확장 대비 추상화. */
public class CursorUtils {

    public record CursorValue(Long likeCount, LocalDateTime createdAt, Long id) {}
    ...
    public static CursorValue decode(String cursorToken) {
        ...
        try {
            ...
            LocalDateTime createdAt =
                    StringUtils.hasText(parts[1]) ? LocalDateTime.parse(parts[1]) : null;
