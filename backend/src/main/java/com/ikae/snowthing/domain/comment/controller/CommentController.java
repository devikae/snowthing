...
public class CommentController {
    ...
    public ResponseEntity<CommentResponse> createComment(
        ...
        CommentResponse response = commentService.createComment(publicId, request, userDetails, clientIp);
    ...
    public ResponseEntity<Map<String, Object>> deleteComment(
        ...
        commentService.deleteComment(commentId, anonymousPassword, userDetails);
